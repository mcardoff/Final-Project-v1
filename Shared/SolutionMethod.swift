...
//            for i in 0..<pTry.flat.count {
//                pTry[i] = sum_[i] * factor1 - vertices[iHighest][i] * factor2
//            }
...
//                                for j in 0..<vertices[i].flat.count {
//                                    vertices[i][j] = vertices[i][j] * 0.5;
//                                }
...
//
//    for i in 0..<(center.flat.count) {
//        center[i] = center[i] / Double(vertices.count)
//    }
...
//        result += sqrt(dotinside(lhs: temp, rhs: temp))
//    }
//

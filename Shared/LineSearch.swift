...
//    }
//
//    func minimizeRacing(problem: inout RacingLineProblem, endCriteria: EndCriteria) -> EndCriteriaType {
//        var ftol = endCriteria.functionEpsilon
//        var maxStationaryStateIterations_ = endCriteria.maxStationaryStateIterations
//        var ecType = EndCriteriaType.None
//        problem.reset()                                      // reset problem
//
//        var x_ = problem.currentXValues
//        var y_ = problem.currentYValues
//        var iterationNumber_ = 0
//
//        // dimension line search
//        lineSearch.searchDirection = Matrix(zeros(x_.count+y_.count))
//        var done = false
//
//        // function and squared norm of gradient values;
//        var fnew : Double
...
//        var sz = lineSearch.searchDirection.flat.count
//
//        var prevXGradient = Array(repeating: 0.0, count: sz)
//        var prevYGradient = Array(repeating: 0.0, count: sz)
//        var d = Array(repeating: 0.0, count: sz)
//        var sddiff = Array(repeating: 0.0, count: sz)
//        var direction = Array(repeating: 0.0, count: sz)
//
//        // Initialize cost function, gradient prevGradient and search direction
//        problem.functionValue = problem.valueAndGradient(gradx: &prevXGradient, grady: &prevYGradient, xs: x_, ys: y_)
//        problem.squaredNorm = dotArray(lhs: prevXGradient, rhs: prevXGradient) + dotArray(lhs: prevYGradient, rhs: prevYGradient)
//
//        var temp = prevXGradient
//        temp.append(contentsOf: prevYGradient)
//        for i in 0..<temp.count {
//            temp[i] *= -1
//        }
//        lineSearch.searchDirection = Matrix(temp)
//
//        var first_time = true
//        // Loop over iterations
//        repeat {
...
//}
//
//func dotArray(lhs: [Double], rhs: [Double]) -> Double {
//    var dot = 0.0
